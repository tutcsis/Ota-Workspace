...
INPUT_PATH="/work/s245302/Ota-Workspace/data/twitter_stream/1000-sampling-media_add/"
OUTPUT_PATH="/work/s245302/Ota-Workspace/data/twitter_stream/1000-toxic-sampling-media_add/"
...
for month in "${months[@]}"; do
  ...
  echo "Processing month: $month"
  qsub ${GPUQOPTS} -N set_${month}_1000toxic_label_media -k doe -j oe -o ./log/set_1000toxic_label_media -v DOCKER_IMAGE=${DOCKER_IMAGE},INPUT_PATH=${INPUT_PATH},OUTPUT_PATH=${OUTPUT_PATH},month=${month} set_month_toxic_label.sh
