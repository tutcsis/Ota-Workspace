#PBS -q gLrchq
#PBS -l select=1:ncpus=4:mem=16G:ngpus=1:vnode=xsnd03
#PBS -v SINGULARITY_IMAGE=imc.tut.ac.jp/transformers-pytorch-cuda118:4.46.3
#PBS -k doe -j oe -o ./log/sample_1000_machine_ja_tweets
...
OUTPUT_PATH="/work/s245302/Ota-Workspace/data/twitter_stream/1000-sampling-machine_add/"
...
mv "./log/sample_1000_machine_ja_tweets/${PBS_JOBID}.OU" "./log/sample_1000_machine_ja_tweets/${PBS_JOBNAME}.o${PBS_JOBID%.xregistry*}"
